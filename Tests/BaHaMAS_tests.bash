...
availableTests=(
    ...
    ['continue-num']='continue --till 10000 --walltime 1d'
    ...
    ['continue-therm-num']='continue-thermalization --till 5000 --walltime 1d'
    ...
    ['simulation-status-time']='simulation-status --doNotMeasureTime'
    ['simulation-status-queued']='simulation-status --showOnlyQueued'
